...
/** 设置导航栏背景图 */
    [[UINavigationBar appearance] setBackgroundImage:[UIImage imageNamed:@"bg_color_yellow"] forBarMetrics:UIBarMetricsDefault];
/** 配置导航栏题目的样式 */
...
- (RESideMenu *)sideMenu{
    if (!_sideMenu) {
        ...
        _sideMenu.backgroundImage =[UIImage imageNamed:@"10979718_0800"];
        //可以让出现菜单时不显示状态栏
