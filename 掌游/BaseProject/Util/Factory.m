...
+ (void)addMenuItemToVC:(UIViewController *)vc{
    ...
    [btn setBackgroundImage:[UIImage imageNamed:@"hardware_load"] forState:UIControlStateNormal];
    [btn setBackgroundImage:[UIImage imageNamed:@"hardware_load"] forState:UIControlStateHighlighted];
