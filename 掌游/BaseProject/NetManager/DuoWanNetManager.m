...
+ (id)getheroVideoDetailWithVid:(NSString *)vid completionHandle:(void (^)(id, NSError *))completionHandle
{
    return [self GET:kVideoDetailPath parameters:@{@"action":@"f",@"vid":vid} completionHandler:^(id responseObj, NSError *error) {
